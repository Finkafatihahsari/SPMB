...
<head>
		...
		<meta charset="utf-8" />
		<title>Form Unit - SPMB Admin</title>

		<meta name="description" content="Common form Unit and layouts" />
		...
		<!-- HTML5shiv and Respond.js for IE8 to support HTML5 Unit and media queries -->
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li>
						<a href="form-unit" class="dropdown-toggle">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Unit </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Kode Unit" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
<![endif]-->
		...
		<!-- ace scripts -->
		<script src="assets/js/ace-Unit.min.js"></script>
